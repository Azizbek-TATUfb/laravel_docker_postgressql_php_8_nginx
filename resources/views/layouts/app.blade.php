        ...
        <div class="header__top">
            ...
            <div class="header-dropdown">
                <div class="header-dropdown__active">
                    <img class="header-icon" src="/app/images/russia.webp" alt="flag">
                    <span>Русский</span>
                </div>
                <ul class="header-dropdown__list">
                    <li class="header-dropdown__item">
                        <img class="header-icon" src="/app/images/uzbekistan.webp" alt="flag">
                        <span>O'zbek</span>
                    </li>

                    <li class="header-dropdown__item">
                        <img class="header-icon" src="/app/images/united-kingdom.webp" alt="flag">
                        <span>Enlish</span>
                    </li>
                </ul>
