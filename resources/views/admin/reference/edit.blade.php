...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('admin.reference.update', $reference->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                <input type="hidden" value="{{ $reference->references_type_id }}" name="references_type_id">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="excerpt_uz" rows="3" id="excerpt_uz"
                                                      class="form-control  {{ empty($errors->first('excerpt_uz'))?:'is-invalid' }}">{{ $reference->excerpt_uz }}</textarea>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_uz" rows="3" id="content_uz"
                                                      class="form-control ckeditor  {{ empty($errors->first('content_uz'))?:'is-invalid' }}">{{ $reference->content_uz }}</textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="excerpt_ru" rows="3" id="excerpt_ru"
                                                      class="form-control  {{ empty($errors->first('excerpt_ru'))?:'is-invalid' }}">{{ $reference->excerpt_ru }}</textarea>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_ru" rows="3" id="content_ru"
                                                      class="form-control ckeditor  {{ empty($errors->first('content_ru'))?:'is-invalid' }}">{{ $reference->content_ru }}</textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="excerpt_en" rows="3" id="excerpt_en"
                                                      class="form-control  {{ empty($errors->first('excerpt_en'))?:'is-invalid' }}">{{ $reference->excerpt_en }}</textarea>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_en" rows="3" id="content_en"
                                                      class="form-control ckeditor  {{ empty($errors->first('content_en'))?:'is-invalid' }}">{{ $reference->content_en }}</textarea>
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-select form-control form-control-sm  {{ empty($errors->first('status'))?:'is-invalid' }}">
                                        @foreach( StatusHelpers::getStatusList() as $key => $val)
                                            <option value="{{ $key }}" @if($key== $reference->status) selected @endif> {{ $val }} </option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('status') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input type="datetime-local" class="form-control  {{ empty($errors->first('date'))?:'is-invalid' }}"
                                               name="date" value="{{ $reference->date }}">
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('date') }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-9">
                                        <label>Photo</label>
                                        <input type="hidden" value="{{ $reference->attachment_id }}" name="attachment_id_old">
                                    ...
                                    <div class="form-group col-3">
                                            <span  style="position: relative">
                                                 <i class="fa fa-pen" style="position: absolute; right: 3px; margin-top: 3px"></i>
                                                  <img src="{{ !empty($reference->attachment)?$reference->attachment->path:asset('/admin/assets/img/author_logo.png') }}" alt=""
                                                       width="150px"
...
@push('script')
    <script>
        ...
        CKEDITOR.replace('content_uz', {
            filebrowserUploadUrl: "{{route('admin.reference.image-upload', ['_token' => csrf_token() ])}}",
